...
/*
the following code is a sereis for functions in JQuery to send and pull requests
...
{////get the use data
    //send a request
    let pull_request = "https://lancaster.craigslist.org/d/video-gaming/search/vga?query=switch";
